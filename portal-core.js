(function(root,factory){
  ...
  var DESTINATIONS=Object.freeze({
    /* El Despacho: la pantalla de trabajo de Direccion. Tablero normal de la casa
       (repo + Pages + Portero + el Apps Script del board), no un artifact. */
    'SYS-DESPACHO':[
      'https://yodesarrollomx.github.io/yod-despacho/',
      'https://tableros.yodesarrollo.mx/yod-despacho/'
    ],
